    ...
    case "$1" in
        ...
        "Firefox")
         ...
         "MAMP" | "MAMP PRO")
            icon_result=":mamp:"
            ;;
         "Canary Mail" | "HEY" | "Mail" | "Mailspring" | "MailMate" | "Mail")
            icon_result=":mail:"
            ;;
         "WebStorm")
         ...
         "Music" | "Music")
            icon_result=":music:"
            ;;
         "Calendar" | "Calendar" | "Fantastical" | "Cron" | "Amie")
